...
export default function Page() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Click to Win.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Click to Win, accessible from{' '}
            <a
              href='https://www.justclick2win.com'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://www.justclick2win.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul className='mb-10'>
        <li>By email: privacy@justclick2win.com</li>
      </ul>
      <Link href='/' className='text-2xl font-semibold'>
        ← Back to home
      </Link>
